...
namespace Assets.HeroEditor.Common.CharacterScripts
{
    ...
    public class WeaponControls : MonoBehaviour, IChangeState
    {
        ...
        public void changeState()
        {
            ...
            //if (actor.isDead) // Why am I putting this in WeaponControl? It's late and I need to see if it works.
            //{
            //    Character.Animator.SetTrigger(Time.frameCount % 2 == 0 ? "DieBack" : "DieFront"); // Play animation randomly
            //}
        }
    }
}